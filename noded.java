...
title=new JLabel("<html><font color=White size=+2><strong><center><i>Vampire attacks-Draining life from wireless ad-hoc sensor networks-Node D</i></center></strong></font>");
...
title2=new JLabel("<html><font color=Red size=+2><strong><center><i>Send To</i></center></strong></font>");				
	...
	//	 c.add(imageLabel1);
	 ...
	 c.add(sink);
		...
		c.add(nodef);
		c.add(nodesink);	 
		 c.setBackground(new java.awt.Color(139,26,26));
