...
title=new JLabel("<html><font color=White size=+2><strong><center><i>Vampire attacks-Draining life from wireless ad-hoc sensor networks-Node A</i></center></strong></font>");
...
l8=new JLabel("<html><font color=Red size=+2><strong><center><i>Node A</i></center></strong></font>");						   					   						   		   
	...
	c.add(nodea);
		...
		c.add(nodesink);
		 ...
		 c.setBackground(new java.awt.Color(0,165,0));
      ...
      tt = cipherText.substring(0,(cipherText.length()-tt.length()));
        cipherText = cipherText.substring(tt.length(),(cipherText.length()));   
			...
			nw.nodesink.append(tt+"\n");
				...
				nw.nodesink.append("Packet["+1+"]sent:\n");
					try
				{
						Thread.sleep(500);
				}
				...
				nw.nodesink.append("Packet["+3+"]sent:\n");
					try
				{
						Thread.sleep(800);
				}
