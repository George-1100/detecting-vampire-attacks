...
title=new JLabel("<html><font color=White size=+2><strong><center><i>Vampire attacks-Draining life from wireless ad-hoc sensor networks-Node F</i></center></strong></font>");
...
title2=new JLabel("<html><font color=Red size=+2><strong><center><i>Send To</i></center></strong></font>");				
	...
	c.add(nodea);
		...
		c.add(l6);
		c.add(l7);
		 c.setBackground(new java.awt.Color(79,79,47));
