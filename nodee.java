...
class nodeewin extends JFrame implements ActionListener
{
...
title=new JLabel("<html><font color=White size=+2><strong><center><i>Vampire attacks-Draining life from wireless ad-hoc sensor networks-Node E</i></center></strong></font>");
...
c.add(l1);
		...
		c.add(nodef);
		c.add(nodesink);	 
		 c.setBackground(new java.awt.Color(0,134,11));
...
//	title2.setBounds(225,330,500,60);
	...
	t1.setFont(new Font("TimesNewRoman",Font.BOLD,20));
	   ...
	   public class nodee extends UnicastRemoteObject implements srvint
    {		
      
	
    nodeewin nw=new nodeewin();
	

	

		public nodee() throws RemoteException
	{
...
String plainData=tt,cipherText,decryptedText;
	...
	//	JOptionPane.showMessageDialog(null,"File send to node"+temp1[i1]); 
