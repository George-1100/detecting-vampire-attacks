...
title=new JLabel("<html><font color=White size=+2><strong><center><i>Vampire attacks-Draining life from wireless ad-hoc sensor networks-Node B</i></center></strong></font>");
...
c.add(l1);
		...
		c.add(nodef);
		c.add(nodesink); 
		 c.setBackground(new java.awt.Color(47,79,47));
